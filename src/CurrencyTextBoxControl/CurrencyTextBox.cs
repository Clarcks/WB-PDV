...
namespace CurrencyTextBoxControl
{
    public class CurrencyTextBox : TextBox
    {
        ...
        public static readonly DependencyProperty StringFormatProperty = DependencyProperty.Register(
            ...
            typeof(string),
            typeof(CurrencyTextBox),
            new FrameworkPropertyMetadata("N2", StringFormatPropertyChanged));
        ...
        private static void StringFormatPropertyChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
        {
            ...
            textBinding.ConverterCulture.NativeName.Equals("pt-BR");
        ...
        private void TextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (Number < 0 && tb.GetBindingExpression(TextBox.TextProperty).ParentBinding.StringFormat == "N2")
            {
